...
import { ArrowRight, Box, History, LayoutGrid, MessageSquare } from 'lucide-react';

type ToolTab = 'template' | 'element' | 'history' | 'comment';

const TOOL_ITEMS: { key: ToolTab; label: string; icon: React.ComponentType<{ size?: number; strokeWidth?: number }> }[] = [
              ...
              <div className='mb-3'>
                ...
                <div className='grid grid-cols-2 gap-1.5'>
                  {MOCK_RECOMMENDED.map((i) => (
                    <div key={i} className='aspect-square rounded-md border border-gray-200 bg-[#f6f6f7]' />
                  ))}
                </div>
              </div>
